...
| 02 | [SSH Brute Force Detection](02-ssh-brute-force-detection/) | Simulated SSH brute force from Kali, analyzed Wazuh alerts mapped to MITRE ATT&CK, and configured active response to automatically block attackers. |

## What's Next

- RDP brute force detection on Windows endpoint
